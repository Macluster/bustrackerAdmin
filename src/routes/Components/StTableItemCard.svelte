...
<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
    ...
    <td class="px-6 py-4">
        <div class="flex flex-row">
            <select name="" id="" bind:value={status} on:change={onChange}>
               ...
               <div class="w-[5px]"></div>
               <button class="p-1 bg-red-200 rounded-lg" on:click={changeDialogFlag(contents['stId'])}>note</button>
        </div>
    ...
    <td class="px-6 py-4">
        <div class="h-[30px] w-[60px] bg-red-600 rounded-xl flex justify-center items-center">
